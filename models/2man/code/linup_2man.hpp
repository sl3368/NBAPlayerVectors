...
namespace linup_2man_model_namespace {
...
class linup_2man_model : public prob_grad {
private:
    int N;
    int T;
    int K;
    ...
    vector_d mins;
public:
    linup_2man_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "linup_2man_model_namespace::linup_2man_model";
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(y,n,"y",1), (alpha + multiply(get_base1(players,get_base1(player1,n,"player1",1),"players",1),transpose(get_base1(players,get_base1(player2,n,"player2",1),"players",1)))), (sigma / get_base1(mins,n,"mins",1))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "linup_2man_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
typedef linup_2man_model_namespace::linup_2man_model stan_model;
