...
namespace lineup_4man_model_namespace {
...
class lineup_4man_model : public prob_grad {
private:
    int N;
    int T;
    int K;
    ...
    vector_d mins;
public:
    lineup_4man_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "lineup_4man_model_namespace::lineup_4man_model";
        ...
        try {
            {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    for (int k = 1; k <= K; ++k) {
                        ...
                        stan::math::assign(mu, (mu + (((get_base1(players,get_base1(player1,n,"player1",1),k,"players",1) * get_base1(players,get_base1(player2,n,"player2",1),k,"players",1)) * get_base1(players,get_base1(player3,n,"player3",1),k,"players",1)) * get_base1(players,get_base1(player4,n,"player4",1),k,"players",1))));
                    }
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "lineup_4man_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
typedef lineup_4man_model_namespace::lineup_4man_model stan_model;
