...
for k in range(folds):
    ...
    ## Perform SVI
    subprocess.call(["./code/lineup_5man","variational","data","file="+training_fn_string])
    ...
    player5_test = test_data[4]
    mins_test = test_data[5]
    pts_test = test_data[6]
    ...
    for i in range(20):
        ...
        for t in range(len(player1_test)):
            ...
            for i in range(vector_length):
                vector_sum = vector_sum + mean_vecs[player1_test[t]][i] + mean_vecs[player2_test[t]][i] + mean_vecs[player3_test[t]][i] + mean_vecs[player4_test[t]][i] + mean_vecs[player5_test[t]][i]
