...
for k in range(FOLDS):
    ...
    data_dict = { "N":len(tr_player1), "T":len(all_players), "K":k_val, "player1":tr_player1, "player2":tr_player2, "player3":tr_player3, "player4":tr_player4, "y":tr_pts, "mins":tr_mins }
    pystan.misc.stan_rdump(data_dict,directory+"CV/training/"+str(k)+"_fold_"+str(k_val)+".data.R")

    # SAVE THE TESTING DATA
    testing_data = [ts_player1,ts_player2,ts_player3,ts_player4,ts_mins,ts_pts]
